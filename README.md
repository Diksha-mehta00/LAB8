# LAB8Generative-AI-in-Aviation-Day-8
...
genai-business-portfolio/ │ └── day-08-summary-fidelity/ │ └── summary-fidelity-and-report-scaffolding.md
...
Before uploading, confirm:
 ...
 Summary is based on the supplied source
 Important figures are retained
 Complaint categories are preserved
 Positive feedback is distinguished
 Source limitations are included
 No unsupported recommendations are presented as facts
 No financial information is invented
 No passenger-satisfaction score is invented
 No staffing claim is invented
 No successful trial outcome is claimed
 [VERIFY] placeholders are used where required
 Numerical accuracy has been checked
 Claims have been checked against the source
...
Distinguish complaints from positive feedback.
...
Receive human review before the report is finalised.
